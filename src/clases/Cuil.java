...
* @param dniInt DNI como int
     *
     * @param xyChar Sexo de la persona como char. * Masculino: m - Femenino: f
     * - Para Personas Juridicas: cualquier otro caracter * @return El CUIT/CUIL
     * como String *
     */
...
* @param dniInt DNI como int
     *
     * @param xyInt El prefijo del CUIT/CUIL como int * @return El CUIT/CUIL
     * como String *
     */
     ...
     *     
* @param cuit N° de CUIT/CUIL como String * @return Boolean: true si el
     * CUIT/CUIL es correcto, false en caso contrario *
     */
...
* @param xyInt El prefijo como int
     *
     * @param dniInt El DNI como int * @return El digito como int. Si se
     * modifico el prefijo (por 23 o 33) * retorna 23x o 33x donde x es el
     * digito *
     */
